...
const CurveBox = () => {
  return (
    <Container>
        ...
        <Btn>
        <Buttons br = "70px" bd = "" bg = "#56C870" wide='200px' length = "70px" cc = "#383B3F">Find Work</Buttons>
        <Buttons br = "70px" bd = "" bg = "#56C870" wide='230px' length = "70px" cc = "#383B3F">Discover Talent</Buttons>
        </Btn>
    </Container>
  )
}
