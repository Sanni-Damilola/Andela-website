...
const Connection = () => {
  return (
    ...
    <Container>
        <Wrapper>
            <h1>Connecting <span>your brilliance</span>  <br />with opportunity</h1>
            <Buttons br = "50px" bd = "" bg = "#56C870" wide='300px' length = "70px" cc = "black">Apply to the Talent Network</Buttons>
        </Wrapper>
    </Container>
  )
}
